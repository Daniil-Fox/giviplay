...
/* harmony import */ var gsap_all__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gsap/all */ "./node_modules/gsap/ScrambleTextPlugin.js");
/* harmony import */ var gsap_all__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gsap/all */ "./node_modules/gsap/SplitText.js");


gsap__WEBPACK_IMPORTED_MODULE_0__["default"].registerPlugin(gsap_all__WEBPACK_IMPORTED_MODULE_3__.SplitText, gsap_all__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger, gsap_all__WEBPACK_IMPORTED_MODULE_2__.ScrambleTextPlugin);
...
function initHeaderAnimation() {
  ...
  if (!header) return;
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(".header__logo", {
    duration: 0.6,
    y: -30,
    opacity: 0,
    ease: defaultEase
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(".nav__item", {
    duration: 0.5,
    y: -20,
    opacity: 0,
    stagger: 0.05,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(".header__button", {
    duration: 0.5,
    scale: 0,
    opacity: 0,
    stagger: 0.1,
...
function initHeroAnimation() {
  ...
  let splitTitle = gsap_all__WEBPACK_IMPORTED_MODULE_3__.SplitText.create(titleHero, {
    type: "words, lines",
    mask: "lines",
    autoSplit: true
  });
  let splitDesc = gsap_all__WEBPACK_IMPORTED_MODULE_3__.SplitText.create(descHero, {
    type: "words, lines",
    mask: "lines",
    autoSplit: true
  });
  timeline.from(splitTitle.lines, {
    duration: 0.8,
    yPercent: 100,
    opacity: 0,
    stagger: 0.2,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(containerHero, {
    yPercent: 30,
    scrollTrigger: {
      trigger: ".hero",
      start: "top top",
...
function initShowcaseAnimation() {
  ...
  const showcaseTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
    scrollTrigger: {
      trigger: showcase,
      start: "top 80%",
...
function initCatalogAnimation() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(".catalog__btn", {
    scrollTrigger: {
      trigger: catalog,
      start: "top 80%",
      toggleActions: "play none none none"
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(".catalog__item", {
    scrollTrigger: {
      trigger: catalog,
      start: "top 70%",
      toggleActions: "play none none none"
...
function initFindAnimation() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(".find-form", {
    scrollTrigger: {
      trigger: find,
      start: "top 75%",
      toggleActions: "play none none none"
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(".find__video", {
    scrollTrigger: {
      trigger: find,
      start: "top 75%",
      toggleActions: "play none none none"
...
function initBenefitsAnimation() {
  ...
  benefitsTimeline.from(".benefits__item", {
    ...
    ease: "power2.out"
  }, "-=0.3").from(".benefits__img", {
    duration: 1,
    y: 100,
    opacity: 0,
    ease: "power2.out"
  }, "-=0.4").from(".benefits__socials", {
    duration: 0.6,
    y: 30,
    opacity: 0,
    ease: defaultEase
...
function initGuideAnimation() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(".guide__item-capture", {
    scrollTrigger: {
      trigger: guide,
      start: "top 75%",
      toggleActions: "play none none none"
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].from(".guide__item-icon", {
    scrollTrigger: {
      trigger: guide,
      start: "top 75%",
      toggleActions: "play none none none"
...
function initConsultAnimation() {
  ...
  consultTimeline.from(".consult__desc", {
    ...
    opacity: 0,
    ease: defaultEase
  }, "-=0.3").from(".consult__btn", {
    duration: 0.6,
    scale: 0.9,
    opacity: 0,
    ease: "back.out(1.7)"
  }, "-=0.2").from(".consult__img", {
    duration: 1,
    y: 100,
    opacity: 0,
    ease: "power2.out"
...
function initGetPackAnimation() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(rows, {
    clipPath: fromClip,
    webkitClipPath: fromClip
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(rows, {
    clipPath: toClip,
...
function initFooterAnimation() {
  ...
  const footerTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
    scrollTrigger: {
      trigger: footer,
      start: "top 85%",
      toggleActions: "play none none none"
...
/***/ "./src/js/components/cart-sticky.js"
/*!******************************************!*\
  !*** ./src/js/components/cart-sticky.js ***!
  \******************************************/
(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/js/components/filters-table.js"
/*!********************************************!*\
  !*** ./src/js/components/filters-table.js ***!
  \********************************************/
(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
if (filtersTable) {
  const tween = gsap_gsap_core__WEBPACK_IMPORTED_MODULE_0__.gsap.to(filtersTable, {
    clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)",
    duration: 0.4
  });
  tween.pause();
...
/***/ "./src/js/components/find-form.js"
/*!****************************************!*\
  !*** ./src/js/components/find-form.js ***!
  \****************************************/
(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
class FindForm {
  ...
  setMaxHeight() {
    ...
    this.slides.forEach((slide, index) => {
      slide.style.display = originalDisplays[index] || (index === 0 ? "block" : "none");
  ...
  isSlideValid(slideIndex) {
    ...
    const checkedCheckboxes = slide.querySelectorAll('input[type="checkbox"]:checked');
  ...
  goToSlide(targetIndex) {
    ...
    setTimeout(() => {
      ...
      this.wrapper.style.transition = "transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)";
...
(function () {
  ...
  const getPair = burger => {
    ...
    const overlay = document.querySelector(`[data-menu-overlay="${id}"]`) || menu?.querySelector("[data-menu-overlay]");
